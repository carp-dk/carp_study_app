...
class AuthService {
  ...
  // ponytail: CAWS has no code -> link endpoint yet, so every code is reported
  // as invalid. Point this at the endpoint once it exists.
  Future<String?> magicLinkForCode(String code) async => null;
